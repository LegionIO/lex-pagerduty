module Legion::Extensions::Pagerduty::Runners
  module EscalationPolicies
    ...
    def delete(**opts)
      # https://developer.pagerduty.com/api-reference/reference/REST/openapiv3.json/paths/~1escalation_policies~1%7Bid%7D/delete
    end
    ...
    def list_audit_records(**opts)
      # https://developer.pagerduty.com/api-reference/reference/REST/openapiv3.json/paths/~1escalation_policies~1%7Bid%7D~1audit~1records/get
    end
